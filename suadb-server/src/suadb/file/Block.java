...
public class Block {
	...
	/**
	 * Returns the name of the suadb.file where the block lives.
	 * @return the filename
	 */
	...
	/**
	 * Returns the location of the block within the suadb.file.
	...
	public String toString() {
		return "[suadb.file " + filename + ", block " + blknum + "]";
	}
