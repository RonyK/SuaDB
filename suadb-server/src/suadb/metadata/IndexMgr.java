...
import static suadb.metadata.TableMgr.MAX_NAME;
import suadb.tx.Transaction;
import suadb.record.*;
import java.util.*;

/**
 * The suadb.index manager.
 * The suadb.index manager has similar functionalty to the table manager.
...
public class IndexMgr {
	...
	/**
	 * Creates the suadb.index manager.
	...
	/**
	 * Creates an suadb.index of the specified type for the specified field.
	 * A unique ID is assigned to this suadb.index, and its information
	...
	/**
	 * Returns a map containing the suadb.index info for all indexes
