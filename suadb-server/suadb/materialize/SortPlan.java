...
public class SortPlan implements Plan {
   ...
   /**
    * Creates a sort plan for the specified suadb.query.
    * @param p the plan for the underlying suadb.query
    ...
    * is the same as in the underlying suadb.query.
