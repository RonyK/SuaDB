...
public class TableInfo {
    ...
    * specified suadb.metadata.
    * This constructor is used when the suadb.metadata
    * is retrieved from the catalog.
    * @param tblname the name of the table
    * @param schema the schema of the table's records
    * @param offsets the already-calculated offsets of the fields within a suadb.record
    * @param recordlen the already-calculated length of each suadb.record
    */
    ...
    * followed by ".tbl".
    * @return the name of the suadb.file assigned to the table
    */
    ...
    * @return the table's suadb.record schema
    */
   ...
   /**
    * Returns the offset of a specified field within a suadb.record
    * @param fldname the name of the field
    * @return the offset of that field within a suadb.record
    */
   ...
   /**
    * Returns the length of a suadb.record, in bytes.
    * @return the length in bytes of a suadb.record
    */
