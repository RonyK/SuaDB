...
/**
 * The parser for the <i>create suadb.index</i> statement.
...
public class CreateIndexData {
	...
	/**
	 * Saves the table and field names of the specified suadb.index.
	 */
	...
	/**
	 * Returns the name of the suadb.index.
	 * @return the name of the suadb.index
	 */
